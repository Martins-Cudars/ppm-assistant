...
class BaseRenderer {
  ...
  static renderComparison(
    ...
    const ratingOuter = document.createElement(
      "div"
    ) as unknown as HTMLDivElement; // Explicit casts HTMLDivElement; // Use 'div' instead of 'span'
    const ratingInner = document.createElement(
      "div"
    ) as unknown as HTMLDivElement; // Use 'div' instead of 'span'
  ...
  static renderButton(text: string): HTMLButtonElement {
