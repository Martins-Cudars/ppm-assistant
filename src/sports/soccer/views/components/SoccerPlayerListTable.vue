...
const tableColumns = computed<Column[]>(() => {
  const baseColumns: Column[] = [
    ...
    {
      header: props.headers[3] || "Goa",
      key: "player.skills.goalie",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[4] || "Def",
      key: "player.skills.defence",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[5] || "Mid",
      key: "player.skills.midfield",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[6] || "Off",
      key: "player.skills.offence",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[7] || "Sho",
      key: "player.skills.shooting",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[8] || "Pas",
      key: "player.skills.passing",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[9] || "Tec",
      key: "player.skills.technical",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[10] || "Spe",
      key: "player.skills.speed",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[11] || "Hea",
