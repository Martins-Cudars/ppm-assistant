...
const tableColumns = computed<Column[]>(() => {
  const baseColumns: Column[] = [
    ...
    {
      header: props.headers[1] || "Poz",
      key: "lineupPosition",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[2] || "Age",
      key: "player.age",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[3] || "VidV",
      key: "player.averageTrainingRatio",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[4] || "CL",
    ...
    {
      header: props.headers[5] || "Goa",
      key: "player.skills.goalie",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[6] || "Def",
      key: "player.skills.defence",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[7] || "Mid",
      key: "player.skills.midfield",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[8] || "Off",
      key: "player.skills.offence",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[9] || "Sho",
      key: "player.skills.shooting",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[10] || "Pas",
      key: "player.skills.passing",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[11] || "Tec",
      key: "player.skills.technical",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[12] || "Spe",
      key: "player.skills.speed",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[13] || "Hea",
      key: "player.skills.heading",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[14] || "Exp",
      key: "player.experience",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[15] || "OR",
      key: "player.overallRating",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[16] || "VP",
      key: "preferredSide",
      sortable: true,
      headerClass: "th1",
    },
