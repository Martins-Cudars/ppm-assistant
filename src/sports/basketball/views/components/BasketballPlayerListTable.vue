...
const tableColumns = computed<Column[]>(() => {
  const cols: Column[] = [
    ...
    {
      header: props.headers[5] || "Sho",
      key: "player.skills.shooting",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[6] || "Blo",
      key: "player.skills.blocking",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[7] || "Pas",
      key: "player.skills.passing",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[8] || "Tec",
      key: "player.skills.technical",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[9] || "Spe",
      key: "player.skills.speed",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[10] || "Agg",
      key: "player.skills.aggression",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[11] || "Jum",
      key: "player.skills.jumping",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[12] || "Exp",
      key: "player.experience",
      sortable: true,
      headerClass: "th1",
    },
    {
      header: props.headers[13] || "OR",
      key: "player.overallRating",
      sortable: true,
      headerClass: "th2",
    },
    {
      header: props.headers[14] || "Height",
      key: "player.height",
      sortable: true,
      headerClass: "th1",
    },
