 ...
 */ const initHockey = ()=>{
    ...
    if (window.location.href.includes("mainas")) (0, _viewLineupDefault.default)();
    if (window.location.href.includes("speletaju-trenini")) (0, _viewTrainingDefault.default)();
    if (window.location.href.includes("rediget-mainu")) (0, _viewLineupChangeDefault.default)();
    if (window.location.href.includes("/lv/tirgus")) (0, _viewMarketDefault.default)();
    if (window.location.href.includes("treninnometne")) (0, _viewTrainingCampDefault.default)();
};
exports.default = initHockey;

},{"./views/viewPlayerList":"cz51W","./views/viewPlayerProfile":"dW5Ci","./views/viewLineup":"2lgZC","./views/viewLineupChange":"3H7rA","./views/viewMarket":"89fpl","./views/viewTraining":"1zmuv","./views/viewTrainingCamp":"4uAmO","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"cz51W":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const viewPlayerProfile = ()=>{
   ...
   */ const potentialBox = document.createElement("div");
    ...
    const bestPotential = (0, _calculationsJs.calculateBestPotential)(potentials);
...
},{"../settings":"aAEvc","~/src/calculations.js":"6mg5U","~/src/render":"5eDoo","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"mJRmF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewPlayerList = require("./views/viewPlayerList");
var _viewPlayerListDefault = parcelHelpers.interopDefault(_viewPlayerList);
