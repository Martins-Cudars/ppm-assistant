...
${frame.code}`;
    ...
    fZBAS: [
      function (require, module, exports) {
        ...
        if (window.location.href.includes("hockey.powerplaymanager.com"))
          (0, _hockeyJsDefault.default)();
        if (window.location.href.includes("soccer.powerplaymanager.com"))
          (0, _soccerJsDefault.default)();
        if (window.location.href.includes("basketball.powerplaymanager.com"))
          (0, _basketballDefault.default)();
      },
      {
        "~/src/hockey/hockey.js": "kzP6H",
        "~/src/soccer/soccer.js": "mJRmF",
        "@parcel/transformer-js/src/esmodule-helpers.js": "5oERU",
        "./basketball/basketball": "5Tlaz",
      },
    ],
    kzP6H: [
      function (require, module, exports) {
        ...
        var _viewPlayerListDefault =
          parcelHelpers.interopDefault(_viewPlayerList);
        var _viewPlayerProfile = require("./views/viewPlayerProfile");
        var _viewPlayerProfileDefault =
          parcelHelpers.interopDefault(_viewPlayerProfile);
        ...
        var _viewLineupChangeDefault =
          parcelHelpers.interopDefault(_viewLineupChange);
        ...
        var _viewTrainingCampDefault =
          parcelHelpers.interopDefault(_viewTrainingCamp);
        /**
         * Run View Functions
         */ const initHockey = () => {
          const urlRegex =
          ...
          if (
            (0, _routesDefault.default).playersOverview.includes(getRoute(url))
          )
            (0, _viewPlayerListDefault.default)();
          if ((0, _routesDefault.default).playerProfile.includes(getRoute(url)))
            (0, _viewPlayerProfileDefault.default)();
          if (
            (0, _routesDefault.default).playerTraining.includes(getRoute(url))
          )
            (0, _viewTrainingDefault.default)();
          if ((0, _routesDefault.default).lines.includes(getRoute(url)))
            (0, _viewLineupDefault.default)();
          if ((0, _routesDefault.default).editLine.includes(getRoute(url)))
            (0, _viewLineupChangeDefault.default)();
          if ((0, _routesDefault.default).market.includes(getRoute(url)))
            (0, _viewMarketDefault.default)();
          if ((0, _routesDefault.default).trainingCamp.includes(getRoute(url)))
            (0, _viewTrainingCampDefault.default)();
      ...
      {
        "./views/viewPlayerList": "cz51W",
        "./views/viewPlayerProfile": "dW5Ci",
        "./views/viewLineup": "2lgZC",
        "./views/viewLineupChange": "3H7rA",
        "./views/viewMarket": "89fpl",
        "./views/viewTraining": "1zmuv",
        "./views/viewTrainingCamp": "4uAmO",
        "@parcel/transformer-js/src/esmodule-helpers.js": "5oERU",
        "./routes": "3cZG7",
      },
    ],
      ...
      function (require, module, exports) {
        ...
        const viewPlayerList = () => {
          ...
          tableHeads.forEach((head) => {
            head
              .querySelector("tr")
              .appendChild((0, _renderJs.renderTableCell)("POS", "th1"));
            head
              .querySelector("tr")
              .appendChild((0, _renderJs.renderTableCell)("SK", "th2"));
            head
              .querySelector("tr")
              .appendChild((0, _renderJs.renderTableCell)("RATING", "th1"));
          });
          playerRows.forEach((playerRow, index) => {
            ...
            const skills = (0, _calculationsJs.calculatePositionsSkills)(
              player,
              (0, _settings.positionSettings)
            );
            const bestPosition = (0, _calculationsJs.calculateBestPosition)(
              skills
            );
            playerRow.classList.add(
              `position-${bestPosition.position.toLowerCase()}`
            );
            const bestSkillWithExp = (0, _calculationsJs.calculateSkillWithExp)(
              bestPosition.level,
              player.experience
            );
            playerRow.appendChild(
              (0, _renderJs.renderTableCell)(
                bestPosition.position,
                `${rowClass}td1`
              )
            );
            playerRow.appendChild(
              (0, _renderJs.renderTableCell)(bestSkillWithExp, `${rowClass}td2`)
            );
            const ratingTd = document.createElement("td");
            ratingTd.classList.add(`${rowClass}td1`);
            ratingTd.appendChild(
              (0, _renderJs.renderComparison)(
                bestSkillWithExp,
                (0, _settings.ratingSettings)
              )
            );
          ...
          const positionButtonAll = (0, _renderJs.renderButton)(
            `All (${playerRows.length})`
          );
          positionFilter.append(positionButtonAll);
          (0, _settings.positionSettings).forEach((pos) => {
            const positionButton = (0, _renderJs.renderButton)(
              `${pos.name} (${
                document.querySelectorAll(`.position-${pos.name.toLowerCase()}`)
                  .length
              })`
            );
            positionButton.addEventListener("click", () =>
              filterByPositions(pos.name)
            );
        ...
        const viewPlayerProfile = () => {
          ...
          const player = {
            ...
            careerLongitivity: parseInt(
              Array.from(
                playerTable.querySelector("#life_time span").textContent
              )[0]
            ),
            skills: {
              goalie: parseInt(
                playerTable.querySelector("#goalie").textContent
              ),
              defence: parseInt(
                playerTable.querySelector("#defense").textContent
              ),
              offence: parseInt(
                playerTable.querySelector("#attack").textContent
              ),
              shooting: parseInt(
                playerTable.querySelector("#shooting").textContent
              ),
              passing: parseInt(
                playerTable.querySelector("#passing").textContent
              ),
              technical: parseInt(
          ...
          const positions = (0, _calculationsJs.calculatePositionsSkills)(
            player,
            (0, _settings.positionSettings)
          );
          const bestPosition = (0, _calculationsJs.calculateBestPosition)(
          ...
          positions.forEach((position) => {
            positionList += `<div>${position.position} ${(0,
            _calculationsJs.calculateSkillWithExp)(
              position.level,
              player.experience
            )}</div>`;
          });
   ...
   <div>(${bestPosition.level})</div>`;
          ...
          comparison.appendChild(
            (0, _renderJs.renderComparison)(
              (0, _calculationsJs.calculateSkillWithExp)(
                bestPosition.level,
                player.experience
              ),
              (0, _settings.ratingSettings)
          ...
          const potentials = (0, _calculationsJs.calculatePositionsQualities)(
            player,
            (0, _settings.positionSettings)
          );
          ...
          const potentialBadge = (0, _renderJs.renderPotentialBadge)(
            bestPotential.potential
          );
          potentialBox.appendChild(potentialBadge);
          const potentialDescription = (0, _renderJs.renderPotential)(
            bestPotential
          );
          ...
          document
            .querySelector(".profile_player_center")
    ...
    hmTWS: [
      function (require, module, exports) {
        ...
        const recalculatePredictDataAccordingToSeasonDay = (
          ...
          const predictData = (0, _settingsJs.playerGrowthPrediction).map(
            (row) => {
              return {
                ...row,
              ...
              datasets: [
                ...
                },
                {
                  ...
                  data: predictData.map((row) => {
                    return {
                      x: row.age,
                      y: (0, _calculationsJs.calculateSkillWithExp)(
                        row.skill,
                        row.exp
                      ),
                    };
    ...
    k5F58: [
      ...
      {
        "./chunks/helpers.segment.js": "6YpJw",
        "@kurkle/color": "jJiT4",
        "@parcel/transformer-js/src/esmodule-helpers.js": "5oERU",
      },
    ],
      ...
      function (require, module, exports) {
         ...
         */ const viewMarket = () => {
          ...
          tableHeads.forEach((head) => {
            ...
            head
              .querySelector("tr")
              .appendChild((0, _renderJs.renderTableCell)("Grd", "th2"));
          });
          ...
          playerRows.forEach((playerRow, index) => {
            ...
            playerRow.appendChild(ratingTd);
            const bestPotential = (0, _calculationsJs.calculateBestPotential)(
              (0, _calculationsJs.calculatePositionsQualities)(
                player,
                (0, _settings.positionSettings)
              )
            );
    ...
    "1zmuv": [
      function (require, module, exports) {
        ...
        const extractSkill = (el) => {
          ...
          return parseInt(
            el.innerHTML.slice(0, qualityElStart).replace(/^\D+/g, "")
          );
        };
        const viewTraining = () => {
          const tableHeads = document
          ...
          tableHeads.forEach((head) => {
            head
              .querySelector("tr")
              .appendChild((0, _render.renderTableCell)("Grd", "th1"));
          });
          playerRows.forEach((playerRow, index) => {
            const rowClass = index % 2 === 0 ? "tr1" : "tr0";
            const playerQualities = playerRow.querySelectorAll(".kva");
            ...
            const playerPositions = (0,
            _calculationsJs.calculatePositionsSkills)(
              player,
              (0, _settings.positionSettings)
            );
            const bestPosition = (0, _calculationsJs.calculateBestPosition)(
            ...
            const potentialBadge = (0, _render.renderPotentialBadge)(
              bestPotential.potential,
              "small"
            );
            const potentialTd = document.createElement("td");
    ...
    mJRmF: [
      function (require, module, exports) {
         ...
         * Run View Functions
         */ const initSoccer = () => {
          if (window.location.href.includes("speletaju-parskats"))
            (0, _viewPlayerListDefault.default)();
          if (window.location.href.includes("speletajs"))
            (0, _viewPlayerProfileDefault.default)();
          if (
            ...
            (0, _viewLineupDefault.default)();
          if (window.location.href.includes("speletaju-trenini"))
            (0, _viewTrainingDefault.default)();
          // if (window.location.href.includes("rediget-mainu")) viewLineupChange();
          if (window.location.href.includes("speletaju-tirgus"))
            (0, _viewMarketDefault.default)();
        };
        exports.default = initSoccer;
      },
      {
        "./views/viewPlayerList": "lRSRi",
        "./views/viewPlayerProfile": "8mBnL",
        "./views/viewLineup": "2pq5S",
        "./views/viewMarket": "7EdSH",
        "./views/viewTraining": "jh5gj",
        "@parcel/transformer-js/src/esmodule-helpers.js": "5oERU",
      },
    ],
    lRSRi: [
      function (require, module, exports) {
        ...
        const viewPlayerList = () => {
          ...
          playerRows.forEach((playerRow, index) => {
            ...
            playerRow.classList.add(
              `pos-${bestPosition.position.toLowerCase()}`
            );
            playerRow.appendChild(
              (0, _renderJs.renderTableCell)(
                bestPosition.position,
          ...
          positionButtonAll.addEventListener("click", () =>
            filterByPositions("All")
          );
          positionFilter.append(positionButtonAll);
          (0, _settings.positionSettings).forEach((pos) => {
            const positionButton = (0, _renderJs.renderButton)(
        ...
        const viewPlayerProfile = () => {
          ...
          const player = {
            ...
            skills: {
              ...
              midfield: parseInt(
                playerTable.querySelector("#midfield").textContent
              ),
              offence: parseInt(
                playerTable.querySelector("#attack").textContent
              ),
              ...
              heading: parseInt(
                playerTable.querySelector("#heading").textContent
              ),
            },
            qualities: {
              goalie: parseInt(
              ...
              speed: parseInt(
                playerTable.querySelector("#kva_speed").textContent
              ),
              heading: parseInt(
                playerTable.querySelector("#kva_heading").textContent
              ),
            },
            experience: parseInt(
              playerTable.querySelector("#experience").textContent
        ...
        const viewLineupChange = () => {
          ...
          const findPosition = (formationId) => {
            ...
            for (const [key, value] of Object.entries(formationPositions))
              if (value.includes(parseInt(formationId))) position = key;
            return position;
          };
          ...
          const showFormationRankings = () => {
            formationSlots.forEach((slot) => {
              ...
              if (player) {
                ...
                const playerSkills = (0,
                _calculationsJs.calculatePositionsSkills)(
                  playerData,
                  (0, _settings.positionSettings)
                );
                const captionEl = player.querySelector(".lineup_spot_caption");
                const skill = (0, _calculationsJs.calculateSkillWithExp)(
                  playerSkills.find((skill) => skill.position === position)
                    .level,
    ...
    "3LAg2": [
      function (require, module, exports) {
        ...
        exports.default = multilangRoutes = {
          ...
          playerProfile: ["/en/player-profile", "/lv/speletaja-profils"],
        };
      },
      { "@parcel/transformer-js/src/esmodule-helpers.js": "5oERU" },
    ],
        ...
        const viewPlayerProfile = () => {
          ...
          const player = {
            ...
            skills: {
              ...
              blocking: parseInt(
                playerTable.querySelector("#block").textContent
              ),
              passing: parseInt(
                playerTable.querySelector("#passing").textContent
              ),
              ...
              jumping: parseInt(
                playerTable.querySelector("#leaping").textContent
              ),
            },
            qualities: {
              shooting: parseInt(
              ...
              blocking: parseInt(
                playerTable.querySelector("#kva_block").textContent
              ),
              passing: parseInt(
                playerTable.querySelector("#kva_passing").textContent
              ),
