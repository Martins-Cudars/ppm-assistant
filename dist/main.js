...
/**
 * View Functions
 */ const $95930220612465e5$var$viewPlayerList = ()=>{
...
const $95930220612465e5$var$viewMarket = ()=>{
    const tableHeads = document.getElementById("table-1").querySelectorAll("thead");
    const playerRows = document.getElementById("table-1").querySelector("tbody").querySelectorAll("tr");
    tableHeads.forEach((head)=>{
        head.querySelector("tr").appendChild((0, $18c53b0039ffc5db$export$b36ad6a61166502b)("POS", "th1"));
...
/**
 * Run View Functions
 */ if (window.location.href.includes("speletaju-parskats")) $95930220612465e5$var$viewPlayerList();
if (window.location.href.includes("speletajs")) $95930220612465e5$var$viewPlayerProfile();
if (window.location.href.includes("rediget-mainu")) $95930220612465e5$var$viewLineupChange();
if (window.location.href.includes("/lv/tirgus")) $95930220612465e5$var$viewMarket();
